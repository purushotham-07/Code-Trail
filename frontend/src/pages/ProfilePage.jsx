...
const statCards = [
  { key: 'totalSnippets', label: 'Total Snippets', icon: 'M13 2 L22 7 L22 17 L13 22 L4 17 L4 7 Z' },
  { key: 'totalForks', label: 'Total Forks', icon: 'M6 3v12 M6 3a3 3 0 1 0 0 6 M18 21a3 3 0 1 0 0-6 M6 15a3 3 0 0 0 3 3h9' },
  { key: 'publicSnippets', label: 'Public Snippets', icon: 'M12 2 L15 8 L22 9 L17 14 L18 21 L12 18.5 L6 21 L7 14 L2 9 L9 8 Z' },
];
...
export default function ProfilePage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      // Ignore errors, profile remains visible with defaults.
    } finally {
      setLoading(false);
    }
  }, [page]);
    ...
    <div className="min-h-screen bg-slate-950 text-slate-50">
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
        ...
        <motion.div
          ...
          className="mb-8 flex flex-wrap items-center gap-5 rounded-xl border border-slate-800 bg-slate-900 p-6"
        >
          <img
            src={user?.avatar}
            alt={user?.name}
        ...
        {loading ? (
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900 p-12 text-center">
            <p className="text-sm text-slate-400">You haven't created any snippets yet.</p>
          </div>
        ) : (
          <>
